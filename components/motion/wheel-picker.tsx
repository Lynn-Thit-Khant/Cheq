...
export function WheelPicker({
  ...
  if (reduce) {
    ...
    return (
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-1 top-1/2 z-10 -translate-y-1/2 rounded-full bg-foreground/[0.04]"
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-x-1 top-1/2 z-10 -translate-y-1/2 overflow-hidden rounded-full bg-foreground/[0.04]"
